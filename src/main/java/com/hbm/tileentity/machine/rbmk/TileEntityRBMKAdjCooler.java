...
public class TileEntityRBMKAdjCooler extends TileEntityRBMKBase implements IFluidHandler, ITankPacketAcceptor {

    public FluidTank tank;
    public int lastCooled;

    public TileEntityRBMKAdjCooler() {
        super();
    ...
    public void update() {
        ...
        if(!world.isRemote) {
            ...
            if((int) (this.heat) > 500) {

                int heatProvided = (int) (this.heat - 500D);
