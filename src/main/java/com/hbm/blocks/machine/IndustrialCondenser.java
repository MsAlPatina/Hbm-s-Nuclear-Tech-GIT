...
import com.hbm.tileentity.machine.TileEntityIndustrialCondenser;
...
public class IndustrialCondenser extends BlockContainer implements ILookOverlay {

    public IndustrialCondenser(Material mat, String s) {
        super(mat);
    ...
    public void printHook(RenderGameOverlayEvent.Pre event, World world, int x, int y, int z) {
        ...
        if(!(te instanceof TileEntityIndustrialCondenser))
            return;
